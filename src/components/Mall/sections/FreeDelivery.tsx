...
const FreeDelivery = () => {
  return (
    <>
      <div className="bg-black bg-opacity-20 h-vh-75 w-full grid grid-row-2 lg:grid-cols-2 text-slate-900">
        <div className="ml-4 p-20 h-full w-full flex flex-col items-center justify-center ">
          <h1 className=" text-6xl my-2 font-bold text-center ">FREE DELIVERY</h1>
          <p className="text-slate-800 text-lg border-b border-black text-center py-3">
