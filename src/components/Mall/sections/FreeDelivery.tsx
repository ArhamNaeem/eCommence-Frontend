...
const FreeDelivery = () => {
  return (
    <>
      <div className="bg-black bg-opacity-20 h-vh-75 text-6xl flex text-slate-900">
        <div className="relative w-3/5">
          <h1 className="absolute top-44 left-40 font-bold ">FREE DELIVERY</h1>
          <p className="text-slate-800 text-lg absolute top-60 left-40  w-1/2 border-b border-black text-center py-3 ">
        ...
        <div className='h-full text-lg text-center'>
          <img
            ...
            alt="image"
            className="opacity-90 h-2/3 mt-24 mb-2 rounded-lg shadow-xl  "
          />
