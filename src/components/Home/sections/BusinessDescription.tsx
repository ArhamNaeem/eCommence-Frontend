    ...
    <>
      <div className="relative h-vh-120 p-10 bg-black bg-opacity-30 text-8xl">
        <h1 className="relative text-5xl left-5 font-bold text-white text-shadow-200 tracking-tight">
          ...
          <span          
            className="  inline-block mx-4 pb-2 relative">
            Ecommerce
        ...
        <motion.div
          ...
          className=" relative mt-16 right-8 h-1/2 w-full "
        >
          <img
        ...
        <div className="bg-black bg-opacity-5 p-6 shadow-lg shadow-slate-600 rounded-lg  top-28 left-12  text-slate-800 absolute text-lg w-2/5">
          ...
          to a range of tools and resources to help you grow your business, from
          easy-to-use listing and inventory management features to marketing and
          advertising opportunities. And as a customer, you'll enjoy a seamless
          and enjoyable shopping experience, with clear and detailed product
          descriptions, fast and reliable shipping, and responsive customer
          support. We're proud to be a rising star in the ecommerce world and
          will continue to focus on delivering the best possible experience for
          everyone who uses our platform. Our commitment to our sellers and
          customers is unwavering, and we're constantly working to improve our
          platform and services to better meet their needs. Whether you're a
          seller looking to grow your business or a customer looking for a great
          shopping experience, you can count on VibeKart to deliver."
        </div>
      </div>
    </>
  );
